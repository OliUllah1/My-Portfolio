...
const Contact = () => {
    return (
        <div id='contact' className='flex mt-40 pt-10 gap-32 mb-28'>
            <div className='flex gap-7 items-center'>
                ...
                <div>
                    <div className='mb-6'>
                        <h1 className='text-[#00cf5d] border-[#00cf5d] font-bold text-2xl border-b-4 pb-1 w-2/3 '>Contact Information</h1>
                ...
                <form className='bg-[#1d293a] w-[650px] rounded-tl-xl rounded-br-xl px-10 py-8'>
                    <div className="">
